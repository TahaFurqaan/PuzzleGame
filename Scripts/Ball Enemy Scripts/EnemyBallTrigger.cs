...
public class EnemyBallTrigger : MonoBehaviour
{
    ...
    {
        //sqr.Magnitude is the speed of rigidbody
    ...
    void SetSoundVolumeOnCollision(Collision collision)
    {
        ...
        //the collision normal is a vector which is used to calculate impulse after collision     
    ...
    IEnumerator BallStunned()
    {
        ...
        //new color rgb in enemy ball standard
    ...
    void OnCollisionEnter(Collision target)
    {
        if(target.gameObject.tag == "Wall")
        {
            ...
            if(!enemyBall.stunned && (Mathf.Abs(velocityLastFrame.x) * xFactor + Mathf.Abs(velocityLastFrame.y) * yFactor
